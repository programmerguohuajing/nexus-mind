(function () {
  const messages = {
    "zh-CN": {
      ...
      "review.description": "Git 活动与日志数据按统计维度自动归并提炼；支持当前仓库用户或所有用户数据统计。",
      "review.periodType": "统计维度",
      "review.periodValue": "复盘周期 / 范围",
      "review.periodWeek": "周复盘 (ISO)",
      "review.periodDay": "日复盘",
      "review.periodMonth": "月度复盘",
      "review.periodQuarter": "季度复盘",
      "review.periodYear": "年度复盘",
      "review.periodCustom": "自定义时间范围",
      ...
      "review.result": "生成结果",
      "review.resultHint": "生成后会在这里显示复盘报告内容",
    ...
    "en-US": {
      ...
      "review.description": "Git activity and daily logs aggregated automatically by selected review period; supports current repository user or all users.",
      "review.periodType": "Period Dimension",
      "review.periodValue": "Review Period / Value",
      "review.periodWeek": "Weekly Review (ISO)",
      "review.periodDay": "Daily Review",
      "review.periodMonth": "Monthly Review",
      "review.periodQuarter": "Quarterly Review",
      "review.periodYear": "Yearly Review",
      "review.periodCustom": "Custom Date Range",
      ...
      "review.resultHint": "The review report will appear here after generation",
      ...
      "review.done": "Review report generated",
